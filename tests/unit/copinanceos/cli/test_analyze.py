...
from copinanceos.cli.analyze import analyze_equity, analyze_macro, analyze_options
from copinanceos.domain.models.job import JobTimeframe, RunJobResult
from copinanceos.domain.models.market import OptionSide


@pytest.mark.unit
class TestAnalyzeCLI:
    @patch("copinanceos.cli.analyze.ensure_profile_with_literacy")
    @patch("copinanceos.cli.analyze.get_storage_path_safe")
    @patch("copinanceos.cli.analyze.container.analyze_instrument_use_case")
    ...
    @patch("copinanceos.cli.analyze.ensure_profile_with_literacy")
    @patch("copinanceos.cli.analyze.get_storage_path_safe")
    @patch("copinanceos.cli.analyze.container.analyze_market_use_case")
    @patch("copinanceos.cli.analyze.console")
