...
from copinance_os.interfaces.cli.profile import (
    create_profile,
    delete_profile,
    get_current_profile,
    get_profile,
...
class TestProfileCLI:
    ...
    @patch("copinance_os.interfaces.cli.profile.container.create_profile_use_case")
    @patch("copinance_os.interfaces.cli.profile.console")
    ...
    @patch("copinance_os.interfaces.cli.profile.container.list_profiles_use_case")
    @patch("copinance_os.interfaces.cli.profile.container.get_current_profile_use_case")
    @patch("copinance_os.interfaces.cli.profile.console")
    ...
    @patch("copinance_os.interfaces.cli.profile.container.get_profile_use_case")
    @patch("copinance_os.interfaces.cli.profile.console")
    ...
    @patch("copinance_os.interfaces.cli.profile.container.set_current_profile_use_case")
    @patch("copinance_os.interfaces.cli.profile.console")
    ...
    @patch("copinance_os.interfaces.cli.profile.container.get_profile_use_case")
    @patch("copinance_os.interfaces.cli.profile.container.get_current_profile_use_case")
    @patch("copinance_os.interfaces.cli.profile.container.delete_profile_use_case")
    @patch("copinance_os.interfaces.cli.profile.typer.confirm")
    @patch("copinance_os.interfaces.cli.profile.console")
