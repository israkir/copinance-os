"""Unit tests for domain indicator helpers used by market regime tools."""

import pytest

from copinance_os.domain.indicators import log_returns_from_prices, simple_moving_average


@pytest.mark.unit
class TestDomainIndicatorHelpersForRegime:
    """Tests aligned with ``domain.indicators`` (used by market regime pipeline)."""
    ...
    def test_calculate_moving_average_sufficient_data(self) -> None:
        ...
        result = simple_moving_average(prices, window)
