...
- **Smart Data Fallbacks**: FRED primary → yfinance secondary
...
### 2. Credit Spreads & Risk Premiums 💰
...
### 7. Consumer Spending & Confidence 🛒
...
from copinanceos.infrastructure.tools.analysis import create_macro_regime_indicators_tool
