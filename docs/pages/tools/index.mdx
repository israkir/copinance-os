...
Copinance OS provides a comprehensive suite of tools for stock research and analysis. Tools are executable functions that can be used in workflows, especially agent workflows where AI agents can dynamically select and use tools to answer questions.

## Tool Categories

### Analysis Tools
Advanced analytical functions for market regime detection, technical analysis, and macroeconomic research.
...
Tools are automatically available when using agent workflows:

```bash
copinance ask "What is the current market trend?" --symbol AAPL
```
