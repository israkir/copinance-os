...
# Deterministic macro regime (custom index)
copinance analyze macro --market-index SPY

# Question-driven equity: AI answers using tools
copinance analyze equity AAPL --question "What are the key risks?"

# Question-driven options: AI summarizes options for date
copinance analyze options AAPL --question "Summarize AAPL options for June 2026" --expiration 2026-06-19
```
