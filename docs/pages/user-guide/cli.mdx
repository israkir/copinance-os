...
Deterministic **only**: fetches quote + default full chain and prints the same aggregate **`positioning`** payload as the instrument executor (snake_case fields). No `--question` / streaming.
