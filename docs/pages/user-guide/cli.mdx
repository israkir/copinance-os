...
**Options:**
- **`--window` / `-w`**: `near` (default) or `mid` — horizon damping for the positioning score (see [Library — Options positioning context](../getting-started/library#options-positioning-context)).
