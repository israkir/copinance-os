...
- **Repository:** [options positioning — library integration notes](https://github.com/copinance/copinance-os/blob/main/docs/integration/options-positioning-library-integration.md) (I/O contracts, pitfalls, test paths)
