...
| `option_greeks_methodology_version` | `quantlib_bsm_v2` | Methodology contract version for transparent clients |
| `option_greeks_assumptions` | `European exercise; ...` | Core model assumptions used for run-level interpretation |
| `option_greeks_references` | `REF_QUANTLIB_ANALYTIC_EUROPEAN,...` | Reference identifiers tied to Greeks methodology |
