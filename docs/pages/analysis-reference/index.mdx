...
| [Options & Greeks](options-and-greeks) | QuantLib BSM Greek estimation, implied vol normalization, metadata contract; aggregate **positioning** (`data.analytics.options.positioning`) |
