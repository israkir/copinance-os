...
| Page | What it covers |
|------|----------------|
| [Market Data Tools](market-data-tools) | Quotes, history, search, options chains, fundamentals — the tool layer wrapping providers |
| [Macro & Market Regime](macro-regime) | Trend, volatility, cycle detection; VIX, breadth, sector rotation; 47+ FRED macro indicators |
| [Options & Greeks](options-and-greeks) | QuantLib BSM Greek estimation, implied vol normalization, metadata contract |
