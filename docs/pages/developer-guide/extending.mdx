...
**Note:** If you're using LLM features, make sure to provide `LLMConfig` when creating the container. See [Configuration Guide](../user-guide/configuration#library-integration) for details.
...
You can also set `COPINANCEOS_CACHE_ENABLED=false` (see [Configuration](/user-guide/configuration#cache)).
