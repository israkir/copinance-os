...
The same field applies to **`MarketNarrativeRequest`** and **`GenerateCuratedQuestionsRequest`** (Ask AI chips grounded in a payload you already fetched). See [Curated questions (clients)](curated-questions-integration).
