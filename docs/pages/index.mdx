...
| Idea | What it means |
|------|----------------|
| **Numbers first** | Prices, history, fundamentals, volatility context, macro series, and options analytics (**QuantLib**-based Greeks where applicable, plus deterministic **aggregate positioning** for the chain surface) are produced by ordinary code paths you can test and inspect. The system favors **structured results** over free-form blobs so every run is auditable. |
