...
- **Literacy context (all modes)** — Optional `financial_literacy` (`beginner` / `intermediate` / `advanced`) controls tiered deterministic narration in summaries, regime/macro labels, and report-envelope text. If omitted, default is `intermediate`.
