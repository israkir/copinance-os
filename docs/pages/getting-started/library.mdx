...
For **options-surface / positioning intelligence** (bias, IV/skew/term, flow-style signals, gamma regime, max pain, implied move, OI clusters) as a **single JSON payload** aligned with the Copinance screener API, use:
