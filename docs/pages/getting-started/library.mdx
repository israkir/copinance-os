...
**Repository note:** [Options positioning — library integration](https://github.com/copinance/copinance-os/blob/main/docs/integration/options-positioning-library-integration.md) (metadata alignment, literacy, test paths).
