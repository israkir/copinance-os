...
**Implemented backends:** **`gemini`** and **`ollama`** only. Other provider names in the LLM factory are rejected until implemented (see [Using as a Library — LLMConfig](library#llmconfig-required-for-question-driven-analysis)).
